...
@section('content')
            ...
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb">
                    <ol class="breadcrumb bg-transparent mb-0 pb-0 pt-1 px-0 me-sm-6 me-5">
                        ...
                        <li class="breadcrumb-item text-sm text-white active" aria-current="page">Data Ibu</li>
                    </ol>
                    <h6 class="font-weight-bolder text-white mb-0">Edit Data Ibu</h6>
                </nav>
                        ...
                        <div class="col-lg-7 col-md-7 col-sm-12 mt-3">
                            <div class="card" style="height: 100%">
                                <div class="card-body px-0 pt-0 pb-2 mt-3">
                                    <div class="container"> 
                                        <form action="{{ route('k/update_ibu', $ibus->id) }}" method="post" enctype="multipart/form-data">
                                            @csrf
                                            @method('PUT')
                                            <div class="mb-3">
                                                ...
                                                <input type="text"
                                                    ...
                                                    name="email" value="{{ old('email', $ibus->email) }}">
                                                @error('email')
                                                    <script>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="regex" class="form-control @error('nik') is-invalid @enderror" id="nik" name="nik"
                                                    value="{{ old('nik', $ibus->nik) }}" onkeypress="return hanyaAngka(event)"
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text"
                                                    ...
                                                    id="nama_ibu" name="nama_ibu" value="{{ old('nama_ibu', $ibus->nama_ibu) }}">
                                                @error('nama_ibu')
                                                    <script>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="date" class="form-control" id="tanggal_lahir"
                                                    name="tanggal_lahir" value="{{ old('tanggal_lahir', $ibus->tanggal_lahir) }}">
                                            </div>
                                            <div class="mb-3">
                                                <label for="alamat" class="form-label text-secondary fs-6">Alamat</label>
                                                <textarea class="form-control" id="alamat" name="alamat" rows="3">{{ old('alamat', $ibus->alamat) }}</textarea>
                                            </div>
                                            <div class="mb-3">
                                                <label for="telepon" class="form-label text-secondary fs-6">Nomor
                                                    Handphone</label>
                                                <input type="regex" class="form-control" id="telepon" name="telepon"
                                                    value="{{ old('telepon', $ibus->telepon) }}" onkeypress="return hanyaAngkaa(event)"
                                                    oninput="cekPanjangInputt(this)">
                                            </div>
                                            <div class="form-group">
                                                <label for="foto" class="text-secondary fs-6">Foto Ibu
                                                    (Maksimal 2MB)</label><br>
                                                <input type="file" class="form-control" id="foto"
                                                    name="foto" onchange="ibuPreview(event)">
                                            </div>
                                            <div class="row mt-4">
                                                <div class="col-6">
                                                    <a href="/k/ibu"
    ...
    <script>
        function ibuPreview(event) {
            const reader = new FileReader();
            const image = document.getElementById('ibuPreview');
    ...
    <script>
        if (typeof ErrorEmail !== 'undefined' || typeof ErrorPassword !== 'undefined' || typeof ErrorNik !== 'undefined' || typeof ErrorNama !== 'undefined') {
