            ...
            <div class="card">
                <div class="card-body">
                    <div style="margin-left: 5vh;" class="py-3">
                        <a href="{{ route('pemeriksaan_kader') }}">
                        ...
                        <div class="col-lg-4 col-md-12">
                            <div class="d-flex align-items-center p-3 rounded shadow-sm">
                                ...
                                <div class="text-start">
                                    ...
                                    <p class="mb-0" style="font-size: 1.25rem; font-weight: 800;">
                                        {{ $pemeriksaan->bayi->nama_bayi }}</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-12">
                            <div class="d-flex align-items-center p-3 rounded shadow-sm">
                                ...
                                <div class="text-start">
                                    <small class="text-muted" style="font-size: 1rem; font-weight: 600;">Jenis
                                        Kelamin</small><br>
                                    <p class="mb-0" style="font-size: 1.25rem; font-weight: 800;">
                                        {{ $pemeriksaan->bayi->jenis_kelamin }}</p>
                                </div>
                            </div>
                        </div>
                        <div class="col-lg-4 col-md-12">
                            <div class="d-flex align-items-center p-3 rounded shadow-sm">
                                ...
                                <div class="text-start">
                                    ...
                                    <p class="mb-0" style="font-size: 1.25rem; font-weight: 800;">
                                        {{ number_format($usia_bulan, 0) }} Bulan</p>
                                </div>
                            </div>
                        </div>
                    </div>
                ...
                <div class="col-lg-4 col-md-12">
                    <div class="card shadow-sm">
                        ...
                        ">
                            ...
                            <p class="pb-3" style="font-size: 2.5rem; font-weight: 800;">
                                {{ $pemeriksaan->status_gizi }}</p>
                        </div>
                    </div>
                </div>
            </div>
                            ...
                            <div class="row">
                                ...
                                <div class="col-10 border rounded">
                                    <div class="mx-3 mt-3">
                                        ...
                                        <p>Langkah pertama adalah pengisian data oleh bidan atau kader. Data yang harus
                                            dimasukan meliputi Nama Bayi (otomatis mendapatkan jenis kelamin dan usia bayi),
                                            Berat Badan (BB) dalam satuan kilogram, Tinggi Badan (TB) dalam satuan
                                            centimeter, dan Lingkar Kepala (LK) dalam satuan centimeter. Anda memasukan nama
                                            <b>{{ $pemeriksaan->bayi->nama }} (Otomatis mendapatkan jenis kelamin
                                                {{ $pemeriksaan->bayi->jk == 'L' ? 'Laki-laki' : 'Perempuan' }} dan usia
                                                {{ number_format($usia_bulan, 0) }} bulan), BB {{ $pemeriksaan->bb }}kg,
                                                TB {{ $pemeriksaan->tb }}cm, LK {{ $pemeriksaan->lk }}cm.</b></p>
                                    </div>
                                </div>
                            </div>
                            <div class="row mt-3">
                                <div class="col-10 border rounded">
                                    <div class="mx-3 mt-3">
                                        ...
                                        <p>Setelah data diinput, sistem secara otomatis menghitung Indeks Massa Tubuh (IMT).
                            ...
                            <div class="row mt-3">
                                ...
                                <div class="col-10 border rounded">
                                    <div class="mx-3 mt-3">
                                        ...
                                        <p>Sistem akan mencocokkan nilai IMT, usia, dan jenis kelamin bayi dengan tabel
                                            status gizi, untuk mengetahui apakah bayi masuk kategori: Gizi Buruk, Gizi
                                            Kurang, Gizi Baik, Berpotensi Gizi Lebih, Gizi Lebih, Obesitas.</p>
                                        <p>Berdasarkan data standar, <b>IMT {{ number_format($pemeriksaan->imt, 2) }}</b>
                                            pada bayi
                                            <b>{{ $pemeriksaan->bayi->jk == 'L' ? 'Laki-laki' : 'Perempuan' }}</b> usia
                                            <b>{{ number_format($usia_bulan, 0) }} bulan</b> termasuk dalam kategori
                                            <b>{{ $pemeriksaan->status_gizi }}</b></p>
                                    </div>
                                </div>
                            </div>
                            <div class="row mt-3">
                                <div class="col-10 border rounded">
                                    <div class="mx-3 mt-3">
                                        ...
                                        <p>Setelah status gizi diketahui, sistem akan menentukan asupan nutrisi harian
                                            berdasarkan usia bayi. Nutrisi meliputi: Kalori, Protein, Lemak, Karbohidrat,
                                            Serat.</p>
                                        <p>Berdasarkan data standar, usia <b>{{ number_format($usia_bulan, 0) }} bulan</b>
                                            membutuhkan nutrisi harian sebesar kalori <b>{{ $pemeriksaan->kalori }}kal</b>,
                                            protein <b>{{ $pemeriksaan->protein }}g</b>, lemak
                                            <b>{{ $pemeriksaan->lemak }}g</b>, karbohidrat
                                            <b>{{ $pemeriksaan->karbo }}g</b>, dan serat
                                            <b>{{ $pemeriksaan->serat }}g</b>.</p>
                                    </div>
                                </div>
                                <div class="col-2 text-center">
