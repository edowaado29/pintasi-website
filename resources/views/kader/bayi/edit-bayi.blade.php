...
@section('content')
        ...
        <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl " id="navbarBlur"
            ...
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb">
                    ...
                    <h6 class="font-weight-bolder text-white mb-0">Edit Data Bayi</h6>
                </nav>
                        ...
                        <div class="col-lg-7 col-md-7 col-sm-12 mt-3">
                            <div class="card" style="height: 100%">
                                <div class="card-body px-0 pt-0 pb-2 mt-3">
                                    <div class="container">
                                        <form action="{{ route('k/update_bayi', $bayis->id) }}" method="post"
                                            ...
                                            <div class=" mb-3">
                                                ...
                                                <select id="id_ibu"
                                                    ...
                                                    @foreach ($ibus as $ibu)
                                                        <option value="{{ $ibu->id }}"
                                                            {{ old('id_ibu', $bayis->id_ibu) == $ibu->id ? 'selected' : '' }}>
                                                            {{ $ibu->nama_ibu }}</option>
                                                    @endforeach
                                                </select>
                                                @error('id_ibu')
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text"
                                                    ...
                                                    value="{{ old('nama_bayi', $bayis->nama_bayi) }}">
                                                @error('nama_bayi')
                                                    <script>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="date"
                                                    ...
                                                    value="{{ old('tanggal_lahir', $bayis->tanggal_lahir) }}">
                                                @error('tanggal_lahir')
                                                    <script>
    ...
    <script>
        if (typeof ErrorIbu !== 'undefined' || typeof ErrorNik !== 'undefined' || typeof ErrorNama !== 'undefined' ||
            typeof ErrorJenis !== 'undefined' ||
