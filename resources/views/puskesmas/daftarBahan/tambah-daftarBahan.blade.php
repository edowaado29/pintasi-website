...
@section('content')
                        ...
                        <div class="col-lg-7 col-md-7 col-sm-12 mt-3">
                            <div class="card" style="height: 100%">
                                <div class="card-body px-0 pt-0 pb-2 mt-3">
                                    <div class="container">
                                        <form action="{{ route('b/add_bahan') }}" method="post">
                                            @csrf
                                            <div class="mb-3">
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text"
                                                    ...
                                                    id="kalori" name="kalori" value="{{ old('kalori') }}" onkeypress="return hanyaAngka(event)">
                                                @error('kalori')
                                                    <script>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text"
                                                    ...
                                                    id="protein" name="protein" value="{{ old('protein') }}" onkeypress="return hanyaAngka(event)">
                                                @error('protein')
                                                    <script>
                                            ...
                                            <div class="mb-3">
                                                <label for="lemak" class="form-label text-secondary fs-6">Lemak (gram)
                                                    <span class="text-danger">*</span></label>
                                                <input type="text"
                                                    class="form-control @error('lemak') is-invalid @enderror" id="lemak"
                                                    name="lemak" value="{{ old('lemak') }}" onkeypress="return hanyaAngka(event)">
                                                @error('lemak')
                                                    <script>
                                            ...
                                            <div class="mb-3">
                                                <label for="karbohidrat" class="form-label text-secondary fs-6">Karbohidrat
                                                    (gram)
                                                    <span class="text-danger">*</span></label>
                                                <input type="text"
                                                    class="form-control @error('karbohidrat') is-invalid @enderror"
                                                    id="karbohidrat" name="karbohidrat" value="{{ old('karbohidrat') }}" onkeypress="return hanyaAngka(event)">
                                                @error('karbohidrat')
                                                    <script>
                                            ...
                                            <div class="mb-3">
                                                <label for="serat" class="form-label text-secondary fs-6">Serat (gram)
                                                    <span class="text-danger">*</span></label>
                                                <input type="text"
                                                    class="form-control @error('serat') is-invalid @enderror" id="serat"
                                                    name="serat" value="{{ old('serat') }}" onkeypress="return hanyaAngka(event)">
                                                @error('serat')
                                                    <script>
    ...
    <script>
        if (typeof ErrorNama !== 'undefined' || typeof ErrorKalori !== 'undefined' || typeof ErrorProtein !== 'undefined' ||
            typeof ErrorLemak !== 'undefined' || typeof ErrorKarbohidrat !== 'undefined' || typeof ErrorSerat !==
            'undefined') {
