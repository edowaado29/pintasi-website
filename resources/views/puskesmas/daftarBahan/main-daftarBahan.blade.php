...
@section('content')
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-lg-6 col-md-6 col-sm-12 px-4">
                                    <a href="/b/tambah_bahan" class="btn btn-sm bg-gradient-primary">Tambah Bahan</a>
                                </div>
                                            ...
                                            <tr>
                                                ...
                                                <td class="align-middle text-sm">
                                                    <form action="/hapus_bahan" method="POST" id="delete-form">
                                                        <a href="{{ route('b/detail_bahan', $bhn->id) }}"
                                                            class="btn btn-sm bg-gradient-primary">Detail</a>
                                                        <a href="{{ route('b/edit_bahan', $bhn->id) }}"
    ...
    <script>
        const baseUrl = "{{ url('b/hapus_bahan') }}";
