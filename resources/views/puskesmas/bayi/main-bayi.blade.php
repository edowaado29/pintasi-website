...
@section('content')
                        ...
                        <div class="container">
                            <div class="row">
                                <div class="col-lg-6 col-md-6 col-sm-12 px-4">
                                    <a href="/b/tambah_bayi" class="btn btn-sm bg-gradient-primary">Tambah Bayi</a>
                                </div>
                                            ...
                                            <tr>
                                                ...
                                                <td class="align-middle text-sm">
                                                    <form action="" method="POST" id="delete-form">
                                                        <a href="{{ route('b/detail_bayi', $by->id) }}"
                                                            class="btn btn-sm bg-gradient-primary">Detail</a>
                                                        <a href="{{ route('b/edit_bayi', $by->id) }}"
    ...
    <script>
        const baseUrl = "{{ url('b/hapus_bayi') }}";
