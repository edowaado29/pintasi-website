                    ...
                    <div class="col-lg-4 col-md-12">
                        <div class="d-flex align-items-center p-3 rounded shadow-sm">
                            ...
                            <div class="text-start">
                                ...
                                <p class="mb-0" style="font-size: 1.25rem; font-weight: 800;">{{ $pemeriksaan->bayi->nama }}</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-12">
                        <div class="d-flex align-items-center p-3 rounded shadow-sm">
                            ...
                            <div class="text-start">
                                ...
                                <p class="mb-0" style="font-size: 1.25rem; font-weight: 800;">{{ $pemeriksaan->bayi->jk == 'L' ? 'Laki-laki' : 'Perempuan' }}</p>
                            </div>
                        </div>
                    </div>
                    <div class="col-lg-4 col-md-12">
