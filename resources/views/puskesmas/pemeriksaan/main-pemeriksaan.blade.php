...
@section('content')
                                        ...
                                        <tr>
                                            ...
                                            <td class="align-middle text-sm">
                                                <form action="" method="post" id="delete-form">
                                                    <a href="{{ route('b/detail_pemeriksaan', $pemeriksaan->id) }}"
                                                        class="btn btn-sm bg-gradient-primary">Detail</a>
                                                    <a href="{{ route('b/edit_pemeriksaan', $pemeriksaan->id) }}"
    ...
    <script>
        document.getElementById('formPilihBayi').addEventListener('submit', function(e) {
            ...
            if (idBayi) {
                window.location.href = "{{ url('/b/tambah_pemeriksaan') }}/" + idBayi;
            } else {
...
<script>
    const baseUrl = "{{ url('b/delete_pemeriksaan') }}";
