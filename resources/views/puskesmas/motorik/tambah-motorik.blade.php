        ...
        <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl " id="navbarBlur"
            ...
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb">
                    ...
                    <h6 class="font-weight-bolder text-white mb-0">Tambah Data Motorik Bayi</h6>
                </nav>
                                ...
                                <div class="card-body px-0 pt-0 pb-2 mt-3">
                                    <div class="container">
                                        <form action="{{route ('add_motorik')}}" method="post">
                                            ...
                                            <div class="mb-3">
                                                <label for="usia" class="form-label text-secondary fs-6">Usia (Bulan)
                                                    <span class="text-danger">*</span></label>
                                                <input type="text"
                                                    class="form-control @error('usia') is-invalid @enderror" id="usia"
                                                    name="usia" value="{{ old('usia') }}" onkeypress="return hanyaAngka(event)"
