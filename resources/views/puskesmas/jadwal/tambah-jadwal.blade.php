        ...
        <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl " id="navbarBlur"
            ...
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb">
                    ...
                    <h6 class="font-weight-bolder text-white mb-0">Tambah Jadwal</h6>
                </nav>
                        ...
                        <div class="col-lg-7 col-md-7 col-sm-12 mt-3">
                            <div class="card" style="height: 100%">
                                <div class="card-body px-0 pt-0 pb-2 mt-3">
                                    <div class="container">
                                        <form action="{{route ('b/add_jadwal')}}" method="post">
                                            @csrf

                                            <div class="mb-3">
                                                <label for="jenis_pemeriksaan" class="form-label text-secondary fs-6">Jenis Pemeriksaan<span class="text-danger">*</span></label></label>
                                                <select class="form-control @error('jenis_pemeriksaan') is-invalid @enderror" id="jenis_pemeriksaan" name="jenis_pemeriksaan">
                                                    <option value="">Pilih Jenis Pemeriksaan</option>
                                                    <option value="Imunisasi" {{ old('jenis_pemeriksaan') == 'Imunisasi' ? 'selected' : '' }}>Imunisasi</option>
                                                    <option value="Posyandu" {{ old('jenis_pemeriksaan') == 'Posyandu' ? 'selected' : '' }}>Posyandu</option>
                                                </select>
                                            ...
                                            <div class="mb-3">
                                                <label for="tanggal_pemeriksaan"
                                                    class="form-label text-secondary fs-6">Tanggal Pemeriksaan<span class="text-danger">*</span></label>
                                                <input type="date" class="form-control @error('tanggal_pemeriksaan') is-invalid @enderror" id="tanggal_pemeriksaan"
                                            ...
                                            <div class="mb-3">
                                                <label for="jam_pemeriksaan" class="form-label text-secondary fs-6">Jam Pemeriksaan<span class="text-danger">*</span></label>
                                                <input type="time" class="form-control @error('jam_pemeriksaan') is-invalid @enderror" id="jam_pemeriksaan"
                                                    name="jam_pemeriksaan" value="{{ old('jam_pemeriksaan') }}">
