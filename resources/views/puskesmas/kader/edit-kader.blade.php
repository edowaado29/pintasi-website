        ...
        <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl " id="navbarBlur"
            ...
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb">
                    ...
                    <h6 class="font-weight-bolder text-white mb-0">Edit Kader</h6>
                </nav>
                        ...
                        <div class="col-lg-7 col-md-7 col-sm-12 mt-3">
                            <div class="card" style="height: 100%">
                                <div class="card-body px-0 pt-0 pb-2 mt-3">
                                    <div class="container">
                                        <form action="{{ route('b/update_kader', $kaders->id) }}" method="post"
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text"
                                                    ...
                                                    name="nama" value="{{ old('nama', $kaders->nama) }}">
                                                @error('nama')
                                                    <script>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text"
                                                    ...
                                                    name="email" value="{{ old('email', $kaders->email) }}">
                                                @error('email')
                                                    <script>
                                            ...
                                            <div class="mb-3">
                                                <label for="role" class="form-label text-secondary fs-6">Role</label>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <textarea class="form-control" id="alamat" name="alamat" rows="3">{{ old('alamat', $kaders->alamat) }}</textarea>
                                            </div>

                                            <div class="form-group">
                                                <label for="foto" class="text-secondary fs-6">Foto Kader
                                                    (Maksimal 2MB) <span class="text-danger">*</span></label><br>
