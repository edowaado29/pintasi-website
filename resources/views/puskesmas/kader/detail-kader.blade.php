        ...
        <nav class="navbar navbar-main navbar-expand-lg px-0 mx-4 shadow-none border-radius-xl " id="navbarBlur"
            ...
            <div class="container-fluid py-1 px-3">
                <nav aria-label="breadcrumb">
                    ...
                    <h6 class="font-weight-bolder text-white mb-0">Detail Kader</h6>
                </nav>
            ...
            <div class="card">
                ...
                <div class="row">
                    <div class="col-lg-3 col-sm-12 px-5 pb-3">
                        <img src="{{ $kaders->foto !== null ? asset('/storage/users/' . $kaders->foto) : asset('/assets/img/no_image.png') }}"
                            style="width: 100%; border: 2px solid #d4d4d4; border-radius: 10px;">
                    </div>
                    <div class="col-lg-9 col-sm-12">
                        <div style="margin-top: 5vh;">
                            <h2 style="font-size: 1.25rem; font-weight: 400; color: grey;">{{ $kaders->id }}</h2>
                            <h3 style="font-size: 2.25rem;">{{ $kaders->nama }}</h3>
                            <h4 style="color: #73A578; font-weight: 400;">{{ $kaders->email }}</h4>
                        </div>
                    </div>
                </div>
                <hr class="horizontal dark mt-0">
                <div class="row mt-3 pb-3">
                    <div class="col-4" style="padding-left: 60px;">
                        <h5 style="font-weight: 500; font-size: 1.15rem;">Role</h5>
