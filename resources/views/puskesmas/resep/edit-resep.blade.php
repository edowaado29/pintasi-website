...
@section('content')
                        ...
                        <div class="col-lg-7 col-md-7 col-sm-12 mt-3">
                            <div class="card" style="height: 100%">
                                <div class="card-body px-0 pt-0 pb-2 mt-3">
                                    <div class="container">
                                        <form action="{{ route('b/update_resep', $reseps->id) }}" method="post"
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <div id="input_fields_wrap">
                                                    @foreach (old('id_daftarBahan', $id_daftarBahan) as $i => $id_daftarBahan)
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <textarea class="form-control @error('langkah') is-invalid @enderror" id="langkah" name="langkah" rows="3">{{ old('langkah', $reseps->langkah) }}</textarea>
                                                @error('langkah')
                                                    <script>
                                            ...
                                            <div class="mb-3">
                                                <label for="jumlah_porsi" class="form-label text-secondary fs-6">Porsi Makan<span
                                                        class="text-danger">*</span></label>
                                                <select class="form-control @error('jumlah_porsi') is-invalid @enderror" id="jumah_porsi" name="jumlah_porsi">
                                                    <option value="">Jumlah Porsi</option>
                                                    <option value="3" {{ old('jumlah_porsi', $reseps->jumlah_porsi) == '3' ? 'selected' : '' }}>3</option>
                                                    <option value="2" {{ old('jumlah_porsi', $reseps->jumlah_porsi) == '2' ? 'selected' : '' }}>2</option>
                                                    <option value="1" {{ old('jumlah_porsi', $reseps->jumlah_porsi) == '1' ? 'selected' : '' }}>1</option>
                                                </select>
                                                @error('jumlah_porsi')
                                                    <script>
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text"
                                                    ...
                                                    id="min_usia" name="min_usia" value="{{ old('min_usia', $reseps->min_usia) }}"
                                            ...
                                            <div class="mb-3">
                                                ...
                                                <input type="text"
                                                    ...
                                                    id="max_usia" name="max_usia" value="{{ old('max_usia', $reseps->max_usia) }}"
                                                    onkeypress="return hanyaAngka(event)" oninput="cekPanjangInput(this)">
                                                @error('max_usia')
                                                    <script>
                                            ...
                                            <div class="row">
                                                <div class="col-md-4 mb-3">
                                                    <label for="total_kalori" class="form-label text-secondary fs-6">Total
                                                        Kalori</label>
                                                    <input type="text" id="total_kalori" name="total_kalori" value="{{ old('total_kalori', $reseps->total_kalori) }}"
                                                        class="form-control" readonly>
                                                </div>
                                                <div class="col-md-4 mb-3">
                                                    <label for="total_protein"
                                                        class="form-label text-secondary fs-6">Total Protein</label>
                                                    <input type="text" id="total_protein" name="total_protein" value="{{ old('total_protein', $reseps->total_protein) }}"
                                                        class="form-control" readonly>
                                                </div>
                                                <div class="col-md-4 mb-3">
                                                    <label for="total_lemak" class="form-label text-secondary fs-6">Total
                                                        Lemak</label>
                                                    <input type="text" id="total_lemak" name="total_lemak" value="{{ old('total_lemak', $reseps->total_lemak) }}"
                                                        class="form-control" readonly>
                                                </div>
                                            </div>
                                            <div class="row">
                                                <div class="col-md-6 mb-3">
                                                    ...
                                                    <input type="text" id="total_karbohidrat" name="total_karbohidrat" value="{{ old('total_karbohidrat', $reseps->total_karbohidrat) }}"
                                                        class="form-control" readonly>
                                                </div>
                                                <div class="col-md-6 mb-3">
                                                    <label for="total_serat" class="form-label text-secondary fs-6">Total
                                                        Serat</label>
                                                    <input type="text" id="total_serat" name="total_serat" value="{{ old('total_serat', $reseps->total_serat) }}"
                                                        class="form-control" readonly>
                                                </div>
                                            </div>
    ...
    <script>
        if (typeof ErrorNama !== 'undefined' || typeof ErrorLangkah !== 'undefined' || typeof ErrorJumlah !== 'undefined' ||
            ...
            typeof ErrorMin !== 'undefined' || typeof ErrorMax !== 'undefined' ||  typeof ErrorGambar !== 'undefined'
        ) {
