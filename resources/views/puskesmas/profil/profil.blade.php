                    ...
                    <div class="col-lg-3 col-md-6 my-sm-auto ms-sm-auto me-sm-0 mx-auto mt-3">
                        <div class="nav-wrapper position-relative end-0">
                            <ul class="nav nav-pills nav-fill p-1" role="tablist">
                                ...
                                <form action="{{ route('b/uploadImg') }}" method="post" enctype="multipart/form-data"
                                    id="fileUploadForm">
                                    @csrf
                                    @method('PUT')
            ...
            <div class="row">
                <div class="col-md-9">
                    <div class="card">
                        ...
                        <div class="card-body">
                            <form action="{{ route('b/updateProfile') }}" method="post" enctype="multipart/form-data">
                                @csrf
                                @method('PUT')
                                <div class="row">
                                    <div class="col-md-6">
        ...
        <div class="modal fade align-items-center" id="exampleModal" tabindex="-1" aria-labelledby="exampleModalLabel"
            ...
            <div class="modal-dialog">
                <div class="modal-content">
                    ...
                    <form action="/b/updatePassword" method="post" enctype="multipart/form-data">
